  ...
  <div class='modal-dialog' role='document'>
    <div class='modal-content' style=' border-radius: 12px;'>
      <div class='modal-header justify-content-center text-white' style='background-color:red;'>
        <h5 class='modal-title text-center'>Gracias por su comentario </h5>
      </div>
      <div class='modal-body ' style='background-color:#e0e0e0;'>
        <p class='text-center ' style='color:black;'>Su comentario <br><?= $comentario ?> <br>fue realizada con exito</p>
      </div>
