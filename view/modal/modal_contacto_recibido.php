  ...
  <div class='modal-dialog' role='document'>
    <div class='modal-content border-0' style=' border-radius: 12px;'>
      <div class='modal-header justify-content-center text-white' style='background-color:red;'>
        <h5 class='modal-title text-center'>Thank you for contacting us
        </h5>
      </div>
      <div class='modal-body ' style='background-color:#e0e0e0;'>
        <p class='text-center ' style='color:black;'>Thank you for contacting us, we will be sending you an email</p>
      </div>
